...
describe('Setting', () => {
  ...
  describe('Rendering and Loading', () => {
    it('should render nothing while loading', async () => {
      ...
      expect(container.innerHTML).toBe(`<div class=\"overflow-hidden animate-pulse\"><div class=\"py-6\"><div class=\"mb-4\"><div class=\"h-8 bg-gray-200 rounded w-3/4 mb-2\"></div><div class=\"flex items-center text-sm mb-3\"><div class=\"h-4 bg-gray-200 rounded w-20\"></div><div class=\"mx-2 h-4 bg-gray-200 rounded w-1\"></div><div class=\"h-4 bg-gray-200 rounded w-16\"></div></div></div><div class=\"mb-4\"><div class=\"space-y-2\"><div class=\"h-4 bg-gray-200 rounded\"></div><div class=\"h-4 bg-gray-200 rounded w-5/6\"></div><div class=\"h-4 bg-gray-200 rounded w-4/6\"></div></div></div><div class=\"flex items-center justify-between pt-4 border-t border-gray-100\"><div class=\"h-4 bg-gray-200 rounded w-20\"></div><div class=\"flex space-x-2\"><div class=\"h-4 bg-gray-200 rounded w-8\"></div><div class=\"h-4 bg-gray-200 rounded w-12\"></div></div></div></div></div>`);
    });
