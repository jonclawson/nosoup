...
describe('Setting', () => {
  ...
  describe('Rendering and Loading', () => {
    it('should render nothing while loading', async () => {
      ...
      expect(container.innerHTML).toBe("<div class=\"overflow-hidden animate-pulse\"><div class=\"py-6\"><div class=\"mb-4\"><div class=\"space-y-2\"><div class=\"h-4 bg-gray-200 rounded\"></div><div class=\"h-4 bg-gray-200 rounded w-5/6\"></div><div class=\"h-4 bg-gray-200 rounded w-4/6\"></div></div></div></div></div>");
    });
